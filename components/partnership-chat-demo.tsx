...
const partnerships: Partnership[] = [
  {
    ...
    conversation: [
      ...
      {
        type: "ai",
        content: "Natuurlijk! Op basis van de missie van VoedselHub en jouw duurzaamheidsexpertise schrijf ik een sterke aanvraag. Welke subsidieregeling had je in gedachten?",
        delay: 1000
      },
      {
        type: "client",
